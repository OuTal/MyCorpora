...
<body >
			...
			<div style="align:center;width:100%;background:#000000;padding:10px;">
				...
				<?php showadmin(); 
				if(isset($_GET['conf'])){echo "<script>alert('Modification effectuée avec succès');</script>";}?>
			...
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/bg-01.jpg);">
					<span class="login100-form-title-1">
						Menu administrateur</span>
				</div>

				<div class="login100-form validate-form" >
					<div style="margin:auto">
					<div class="wrap-input100 validate-input m-b-26" style="border-bottom: 0px">
						<span class="label-input100" style="left:-260px; width:240px">Phrases</span>
						<a href="readphrase.php">
					...
					<div class="wrap-input100 validate-input m-b-26" style="border-bottom: 0px">
						<span class="label-input100" style="left:-260px; width:240px">Enregistrements</span>
						<a href="read.php">
						<button class="login100-form-btn">
						Parcourir
						</button></a>
					...
					<div class="wrap-input100 validate-input m-b-26" style="border-bottom: 0px;">
						<span class="label-input100" style="left:-260px; width:240px">Nouvelle Phrase</span>
						<a href="add.php">
						<button class="login100-form-btn">
						Ajouter
						</button></a>
					...
					<div class="wrap-input100 validate-input m-b-26" style="border-bottom: 0px;">
						<span class="label-input100" style="width:240px"><a href="mod.php" style="color:red">
