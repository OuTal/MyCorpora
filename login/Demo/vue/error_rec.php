	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url(images/bg.jpg)">
			<div class="wrap-login100">
				...
				<p style="text-align: center;margin: 20px;margin-bottom: 10px; padding: 0px">Oops! <br>Notre appliction est incompatible avec les appareils mobiles !<br>Merci de réessayer en vous connectant avec votre ordinateur ou de consulter l'aide.</p>
